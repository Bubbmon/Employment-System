...
create table `talkDetail` (
	`id` bigint(64),
	constraint `talk_c` foreign key (`id`) references `talk`(`id`),
	`time` TIMESTAMP(6) NOT NULL COMMENT '消息发送时间',
	`sender` char(1) NOT NULL COMMENT '发送人 0为普通用户 1为企业用户',
